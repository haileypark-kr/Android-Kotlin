...
//고차함수
fun addTenNine(addNumbersFunc: (Int, Int) -> Int) {
    val result: Int = addNumbersFunc(10, 9)
...
//    result
    number1 + number2 // 리턴이 별도로 없음.
}
addTenNine(addTenNine2) // 람다함수를 인자로 사용하는 경우에는 ::를 사요할 필요가 없다
