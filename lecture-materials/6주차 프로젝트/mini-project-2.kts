 ...
 */
class Duck constructor(age: Int) {
    var age: Int
    var color: String = ""
 ...
 */
abstract class Cat constructor(var age: Int) {

    abstract fun jump(number: Int): String
}

class Tiger constructor(age: Int) : Cat(age) {

    override fun jump(number: Int): String {
        return "$number 미터를 점프 하였습니다."
    }
}
...
//val tiger1 = Tiger(11)
//println(tiger1.age)
//println(tiger1.jump(10))
//val tiger2 = Tiger(20)
//println(tiger2.jump(5))
...
class RealCalaulator : Calculator {
    ...
    override fun mul(num1: Int, num2: Int): Int {
        return num1 * num2
    }
}
